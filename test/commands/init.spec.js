...
describe('init', function () {
  describe('optionsBuilder', function () {
    ...
    it('should have valid keys', function () {
      const option = { name: '' };
      expect(init.optionsBuilder(option)).to.have.all.keys(
        'name',
        'location',
        'longname',
        'layout',
  ...
  describe('confirmSite', function () {
    ...
    it('should return true on default', function () {
      const interact = { interactive: false };
  ...
  describe('inputRest', function () {
    const argv = { interactive: true, name: 'test' };
    let project = new Project();
    const options = {
      author: 'test',
      longname: 'test',
    ...
    it('project.config should have all keys', function () {
      ...
      expect(project.config).to.have.all.keys(
        'name',
        'location',
        'longname',
        'layout',
