...
function handler (argv) {
    ...
    project.config.name = prompt(`Enter short name for the blog: [${options.name}]`, options.name);
    project.config.location = prompt(`Enter the folder on which you want to create the site if different to the name, [${options.location}]`, options.location);
    ...
    project.config.author = prompt(`Author name:`);
    project.config.longname = prompt(`Enter the longname to use in your site's title: [${options.name}]`, options.name);
    project.config.description = prompt(`Enter the description to use in your site:`);
